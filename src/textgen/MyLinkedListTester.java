...
public class MyLinkedListTester {
	...
	public void testSize() {
		...
		assertEquals("Size: check short list size ", 2, shortList.size());
		assertEquals("Size: long empty list size ", 10, longerList.size());
	...
	public void testSet() {
		...
		shortList.set(1, "P");
		assertEquals("AddAtIndex: check value is correct ", "P", shortList.get(1));
